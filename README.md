...
### **Rationale for the Project (Business Impact)**
 ...
 The core problem was the **lack of alignment** between business strategy (marketing, inventory, and promotions) and actual customer behavior and sales pattern
...
**Dataset:** [BikeGear Excel Dashboard](./assets/BikeGear_Solutions_sales_data analysis_Pivot Table_dashboard.xlsx)
